...
- Re-implemented `Create.actor.twitter` to use `dplyr` data manipulation techniques consistent with other package network creation functions.
- Re-implemented and simplified the `Create.activity.twitter` network creation.
