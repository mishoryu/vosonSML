...
#' 
#' @param videoID id string of youtube video
#' @param verbose print processing messages
#' @return data.frame of videoId, authorChannelId.value and authorDisplayName
#' @noRd
GetYoutubeVideoAuthor <- function(videoID, verbose=FALSE) {
  video_channel_id <- ""
  video_channel_title <- ""
  ...
  if (verbose) {
    cat(paste0("get youtube video author:\nvideoId ", videoID, "\nauthorChannelId.value ", 
               video_channel_id, "\nauthorDisplayName ", video_channel_title, "\n\n"))
